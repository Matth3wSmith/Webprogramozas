let adatok=`Albert Laszlo;Felnott ferfi;HOLE HUNTERS;0;0;10;10;0;0;0;10
...
function feladatKiiras(szovegek,sorSzam){
    let feladat1 = document.createElement("div")
    let p = document.createElement("p")
    p.innerHTML=`3. feladat: Versenyzők száma: ${jatekosok.length}`;
    body.appendChild(p)
}
...
function main(){
    ...
    jatekosok=[]
    adatok.forEach(sor => {
        jatekosok.push(new Jatekos(sor.trim()));
    });
